        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          ...
          <ul className="navbar-nav mx-auto">
            ...
            <li className="nav-item">
              <Link className="nav-link mx-lg-3 mx-md-0 mx-sm-0 mx-0" to="/">Home</Link>
            </li>

            <li className="nav-item">
              <Link className="nav-link mx-lg-3 mx-md-0 mx-sm-0 mx-0" to="/products">Products</Link>
            </li>

            <li className="nav-item">
              <Link className="nav-link mx-lg-4 mx-md-0 mx-sm-0 mx-0" to="/orders">Orders</Link>
            </li>
          ...
          <div className="dropdown btn-outline-light my-1 me-5">
            ...
            <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton">
              ...
              {isAuthenticated === true ? (
                ...
                <>
                  {user.role === "admin" &&
                    (<li><Link className="dropdown-item my-2  " to="/admin/dashboard">Dashboard</Link></li>)
                  }
